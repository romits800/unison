...
-- rep (l:_) 0 _ _ _ _ _ _ = l
-- rep [] _ acc i t ps rs rs2 = error ("Not enough elements." ++ show i ++ " " ++ show acc ++ " " ++ show t ++ " " ++ show ps ++ " " ++ show rs ++ " " ++ show rs2)
-- rep (l:[la]) w acc i t ps rs rs2 = error ("Not enough elements." ++ show i ++ " " ++ show (l:[la]) ++ " " ++ show t ++ " " ++ show ps ++ " " ++ show rs)
-- rep (l:ls) w acc i t ps rs rs2 = rep ls (w-1) (l:acc) i t ps rs rs2
