...
allInstructions
  = [ABS, ADCri, ADCrr, ADCrsi, ADCrsr, ADDSri, ADDSrr, ADDSrsi,
     ...
     TUXTB, TUXTH, TLDRspi_fi, T2ADDri_fi, T2LDRi12_fi, T2LDRBi12_fi,
     T2LDRHi12_fi, T2LDRSHi12_fi, T2STRHi12_fi, T2STRi12_fi,
     T2STRBi12_fi, VSTRS_fi, VLDRD_fi, VLDRS_fi, VLDRD_cpi, VLDRS_cpi,
     T2LEApcrel_cpi, MOVE, MOVE_ALL, MOVE_D, STORE, STORE_T, STORE_D,
     LOAD, LOAD_T, LOAD_D, NOP, TMOVi8s, TLSLris, TASRris, TLSRris,
     TSUBi3s, TSUBi8s, TADDi8s, TMULz, TADDi3s, TRSBs, TLSLrrs, TASRrrs,
     TSUBrrs, TADDrrs, TADDhirrs, TORRs, TRORs, TBICs, TUXTBz, TMVNs,
     TANDs, TUXTHz, TEORs, TSXTHz, TLSRrrs, TLDRSHz, TLDRSBz, TLDRHrz,
     TSTRHrz, TSTRrz, TLDRBrz, TSTRBrz, TLDRrz, TCMPi8_cpsr,
     ...
     TFP, TPUSH_r4_7, TPUSH_r8_11, TPUSH2_r4_7, TPUSH2_r4_11,
     VSTMDDB_UPD_d8_15, TPOP_r4_7, TPOP_r8_11, TPOP2_r4_7, TPOP2_r4_11,
