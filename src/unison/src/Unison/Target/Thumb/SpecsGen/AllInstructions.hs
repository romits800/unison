...
module Unison.Target.Thumb.SpecsGen.AllInstructions
...
allInstructions
  = [ABS, ADCri, ADCrr, ADCrsi, ADCrsr, ADDSri, ADDSrr, ADDSrsi,
     ...
     VLDRD_fi, VLDRS_fi, VLDRD_cpi, VLDRS_cpi, T2LEApcrel_cpi,
     TLDRpci_cpi, MOVE, MOVE_ALL, MOVE_D, STORE, STORE_T, STORE_D, LOAD,
     LOAD_T, LOAD_D, NOP, TMOVi8s, TLSLris, TASRris, TLSRris, TSUBi3s,
     TSUBi8s, TADDi8s, TMULz, TADDi3s, TRSBs, TLSLrrs, TASRrrs, TSUBrrs,
     TADDrrs, TADDhirrs, TORRs, TRORs, TBICs, TUXTBz, TMVNs, TANDs,
     TUXTHz, TEORs, TSXTHz, TLSRrrs, TLDRSHz, TLDRSBz, TLDRHrz, TSTRHrz,
     TSTRrz, TLDRBrz, TSTRBrz, TLDRrz, TCMPi8_cpsr, T2CMPri_cpsr,
     T2TSTri_cpsr, T2CMNri_cpsr, T2CMPrr_cpsr, T2TSTrr_cpsr,
     T2CMPrs_cpsr, T2TSTrs_cpsr, T2SUBrr_cpsr, T2SUBri_cpsr,
     T2ORRrr_cpsr, T2ANDri_cpsr, T2ADDri_cpsr, FMSTAT_cpsr, TCMPr_cpsr,
     TCMPhir_cpsr, TTST_cpsr, T2TEQrr_cpsr, TFP, TPUSH_r4_7,
     TPUSH_r8_11, TPUSH2_r4_7, TPUSH2_r4_11, VSTMDDB_UPD_d8_15,
     TPOP_r4_7, TPOP_r4_7_RET, TPOP_r8_11, TPOP2_r4_7, TPOP2_r4_11,
     TPOP2_r4_7_RET, TPOP2_r4_11_RET, VLDMDIA_UPD_d8_15, TSUBspi_pseudo,
     TADDspi_pseudo, MEMCPY_4, T2LDMIA_4, T2LDMIA_UPD_4, T2STMIA_4,
     T2STMIA_UPD_4, Load_merge, T2STMDB_UPD_4_8, T2STMDB_UPD_4_9,
     T2STMDB_UPD_4_10, T2STMDB_UPD_4_11, TPUSH_4, TPUSH_4_5, TPUSH_4_6,
     TPUSH_4_7, TPOP_RET_4, TPOP_RET_4_5, TPOP_RET_4_6, TPOP_RET_4_7,
     ...
     Register_class_decl_dummy, TLDRspi_fi, TSTRspi_fi, TADDframe_cpsr,
     TEOR_r, TAND_r, TORR_r, TBIC_r, TMUL_r, T2MOVi_source,
