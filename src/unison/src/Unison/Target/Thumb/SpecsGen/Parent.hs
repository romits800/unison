...
parent i
  | i `elem`
      [ABS, ADCri, ADCrr, ADCrsi, ADCrsr, ADDSri, ADDSrr, ADDSrsi,
       ...
       TLDRpci, TLDRpci_pic, TLDRr, TLDRspi, TLDRspi_fi, TLEApcrel,
       TLEApcrelJT, TLSLri, TLSLris, TLSLrr, TLSLrrs, TLSRri, TLSRris,
       TLSRrr, TMOVCCr_pseudo, TMOVSr, TMOVi8, TMOVi8s, TMOVr, TMUL,
       TMULz, TMVN, TORR, TPICADD, TPOP, TPOP2_r4_11, TPOP2_r4_7,
