...
module Unison.Target.Thumb.SpecsGen.Parent (parent) where
...
parent i
  | i `elem`
      [ABS, ADCri, ADCrr, ADCrsi, ADCrsr, ADDSri, ADDSrr, ADDSrsi,
       ...
       TADJCALLSTACKDOWN, TADJCALLSTACKUP, TADR, TAND, TAND_r, TASRri,
       TASRris, TASRrr, TASRrrs, TB, TBIC, TBIC_r, TBKPT, TBL, TBLXi,
       TBLXr, TBRIND, TBR_JTr, TBX, TBX_CALL, TBX_RET, TBX_RET_vararg,
       TBcc, TBfar, TCBNZ, TCBZ, TCMNz, TCMPhir, TCMPi8, TCMPr, TCPS,
       TEOR, TEOR_r, THINT, THLT, TInt_WIN_eh_sjlj_longjmp,
       ...
       TLDRspi_fi, TLEApcrel, TLEApcrelJT, TLSLri, TLSLris, TLSLrr,
       TLSLrrs, TLSRri, TLSRris, TLSRrr, TMOVCCr_pseudo, TMOVSr, TMOVi8,
       TMOVi8s, TMOVr, TMUL, TMUL_r, TMULz, TMVN, TORR, TORR_r, TPICADD,
       TPOP, TPOP2_r4_11, TPOP2_r4_7, TPOP_RET, TPOP_r4_7, TPOP_r8_11,
       TPUSH, TPUSH2_r4_11, TPUSH2_r4_7, TPUSH_r4_7, TPUSH_r8_11, TREV,
       TREV16, TREVSH, TROR, TRSB, TRSBs, TSBC, TSETEND, TSTMIA_UPD,
       TSTRBi, TSTRBr, TSTRHi, TSTRHr, TSTRi, TSTRr, TSTRspi, TSTRspi_fi,
       TSUBi3, TSUBi3s, TSUBi8, TSUBi8s, TSUBrr, TSUBrrs, TSUBspi, TSVC,
       TSXTB, TSXTH, TTAILJMPd, TTAILJMPdND, TTAILJMPr, TTPsoft, TTRAP,
       TTST, TUDF, TUXTB, TUXTH]
    = Nothing
