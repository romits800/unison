...
module Unison.Target.Thumb.SpecsGen.InstructionType
...
instructionType i
  ...
  | i `elem`
      [ABS, ADCri, ADCrr, ADCrsi, ADCrsr, ADDSri, ADDSrr, ADDSrsi,
       ...
       TADJCALLSTACKUP, TADR, TAND, TAND_r, TANDs, TASRri, TASRris,
       TASRrr, TASRrrs, TBIC, TBIC_r, TBICs, TBKPT, TCMNz, TCMPhir,
       TCMPhir_cpsr, TCMPi8, TCMPi8_cpsr, TCMPr, TCMPr_cpsr, TCPS, TEOR,
       TEOR_r, TEORs, TFP, THINT, THLT, TInt_WIN_eh_sjlj_longjmp,
