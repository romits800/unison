...
-}
module Unison.Target.Thumb.Transforms
    (extractReturnRegs,
...
{- see expandMEMCPY in ThumbBaseInstrInfo.cpp:
...
{-
 ...
 into:
    ...
    o16: [p47{ -, t30}] <- { -, MOVE_ALL, STORE} [p46{ -, t29}]
 (see 'LoadStoreMultipleOpti' in ThumbLoadStoreOptimizer.cpp)
...
combineLoadStores _ (
  ...
  :
  rest) (tid, oid, pid)
  -- TODO: check offset (lines 2039-2042 in ThumbLoadStoreOptimizer.cpp)
