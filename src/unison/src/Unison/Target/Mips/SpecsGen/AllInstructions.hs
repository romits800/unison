...
allInstructions
  = [ABSQ_S_PH, ABSQ_S_PH_MM, ABSQ_S_QB, ABSQ_S_QB_MMR2, ABSQ_S_W,
     ...
     LB_fi, LHu_fi, SW_fi, SWL_fi, SWR_fi, SB_fi, LDC1_fi, LBu_fi,
     SH_fi, LH_fi, SWC1_fi, LWC1_fi, SUBu_sp, ADDiu_sp, ADDiu_negsp,
     SW_sp, SWC1_sp, SDC1_sp, LoadGPDisp, CLOBBER_RA, B_NOP, BC1F_NOP,
     BC1T_NOP, BEQ_NOP, BGEZ_NOP, BGTZ_NOP, BLEZ_NOP, BLTZ_NOP, BNE_NOP,
